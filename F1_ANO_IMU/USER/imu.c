...
#define Yaw_Filter_Length	30
float Yaw_Filter_Buf[Yaw_Filter_Length]={0};
int Yaw_Cnt=0,i;
float Yaw_Sum=0;
int Temp_Yaw=0;
...
//	
//	Yaw_Cnt++;       
//	if(Yaw_Cnt>=Yaw_Filter_Length)
//		Yaw_Cnt=0;
//	
//	Yaw_Filter_Buf[Yaw_Cnt]=Temp_Yaw;

//	Yaw_Sum=0;
//	for(i=0;i<Yaw_Filter_Length;i++){
//		Yaw_Sum+=Yaw_Filter_Buf[i];
//	}

//	Temp_Yaw=(float)Yaw_Sum/Yaw_Filter_Length;
//	
//	if(*yaw>0){
//		*yaw=Temp_Yaw;
//	}
